...
<html>
	<head>
		...
		<script type="text/javascript" charset='UTF-8'>
			...
			function fnPolarisViewerCall(sTpNm, sUrl, sFileName){
				...
				//link.setAttribute("href", sFullPath);
	...
	<body>
		...
		<button onclick="inAppBrowserOut(fnPolarisViewerCall('https://app-lifeone.koyeb.app', 'https://blog.kakaocdn.net/dn/Ugubl/btrHTWWqcC1/hd6fIBJaEkwmogkpbqS3kk/1%EB%B6%84%ED%8C%8C%EC%9D%B4%EC%8D%AC_%EA%B0%95%EC%9D%98%EC%9E%90%EB%A3%8C_%EC%A0%84%EC%B2%B4.pdf?attach=1&knm=tfile.pdf', 'TEST1'))">링크1(PDF)</button>
		<button onclick="inAppBrowserOut(fnPolarisViewerCall('https://app-lifeone.koyeb.app', 'https://www.kf.or.kr/common/nttFileDownload.do?fileKey=63f76aa67d642f9c01b2c95203eced54', 'TEST2'))">링크2(HWP)</button>
		<button onclick="inAppBrowserOut(fnPolarisViewerCall('https://app-lifeone.koyeb.app', 'https://download.blog.naver.com/open/6cf970c0d0818854799efac6f0136714b3e013febb/BiHMWqWgRKiPnw6NqsgNrJpFcWrKoS0_Y7SBJj8nK7xtH1_rOkE5leREKwiu42V1W_UyBsDy6YXhnkrF2yJ3BQ/%28%EC%A3%BC%29%EC%97%91%EC%85%80%ED%85%8C%ED%81%AC-%EC%8B%A4%EC%8A%B5%EC%98%88%EC%A0%9C%281%29.xlsx', 'TEST3'))">링크3(XLSX)</button>
		<button onclick="inAppBrowserOut(fnPolarisViewerCall('https://app-lifeone.koyeb.app', 'https://scc.sogang.ac.kr/Download?pathStr=NTMjIzUyIyM1MCMjMTI0IyMxMDQjIzExNiMjOTcjIzgwIyMxMDEjIzEwOCMjMTA1IyMxMDIjIzM1IyMzMyMjMzUjIzUwIyMxMjQjIzEyMCMjMTAxIyMxMDAjIzExMCMjMTA1IyMzNSMjMzMjIzM1IyM0OCMjNTEjIzU1IyM1MCMjNTMjIzU1IyMxMjQjIzEwMCMjMTA1IyMxMDcjIzExMg==&fileName=%EC%99%B8%EA%B5%AD%EC%9D%B8%EA%B0%95%EC%82%AC+%EB%AA%A8%EC%A7%91+%EC%A7%80%EC%9B%90%EC%84%9C+%EC%96%91%EC%8B%9D%5B%EC%9B%8C%EB%93%9C%5D.docx&gubun=board', 'TEST4'))">링크4(DOCX)</button>
		<button onclick="inAppBrowserOut(fnPolarisViewerCall('https://app-lifeone.koyeb.app', 'https://www.lettercontest.kr/2023%ED%8E%B8%EC%A7%80%EC%93%B0%EA%B8%B0%EA%B3%B5%EB%AA%A8%EC%A0%84%20%EA%B3%B5%EB%AA%A8%EC%A0%84%20%EA%B0%95%EC%9D%98.pptx', 'TEST5'))">링크5(PPTX)</button>
